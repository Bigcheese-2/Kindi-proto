...
## Tasks / Subtasks
- [ ] Set up react-leaflet integration (AC: 1)
  - [ ] Install react-leaflet and dependencies
  - [ ] Create MapComponent wrapper for react-leaflet
  - [ ] Configure basic map settings and properties
  - [ ] Set up map container with appropriate dimensions

- [ ] Implement location markers (AC: 2)
  - [ ] Create marker component for locations
  - [ ] Implement popup information for markers
  - [ ] Add clustering for dense marker areas
  - [ ] Create marker selection functionality

- [ ] Implement base map options (AC: 3)
  - [ ] Set up default OpenStreetMap layer
  - [ ] Add satellite imagery layer
  - [ ] Add terrain map layer
  - [ ] Create layer control for switching between map types

- [ ] Implement map navigation controls (AC: 4)
  - [ ] Add zoom in/out controls
  - [ ] Implement pan functionality
  - [ ] Add fullscreen toggle
  - [ ] Create home/reset view button

- [ ] Implement marker styling system (AC: 5)
  - [ ] Create custom markers based on entity types
  - [ ] Implement color coding for different entity categories
  - [ ] Add size variation based on importance
  - [ ] Create marker legend for entity types

- [ ] Implement automatic bounds adjustment (AC: 6)
  - [ ] Create function to calculate bounds from visible markers
  - [ ] Implement auto-fit functionality for initial load
  - [ ] Add padding to ensure all markers are visible
  - [ ] Create manual fit button to reset view
...
const handleMarkerSelect = useCallback((locationId) => {
